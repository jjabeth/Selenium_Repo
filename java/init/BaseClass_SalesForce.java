...
public class BaseClass_SalesForce {
	...
	@Parameters({"url","userName","passWord","authorName"})
	@BeforeMethod
	public void preCondition(String url, String userName, String passWord, String authorName) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@class='slds-input'])[2]")).sendKeys(authorName);
	}

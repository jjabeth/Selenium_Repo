...
public class CheckBox {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("//div[contains(@class,'ui-toggleswitch-slider')]"));

		element.click();
		driver.close();

		//Verify that the expected message is displayed.
		WebElement toggleNotification = driver.findElement(By.xpath("//div[@class='ui-growl-message']/following::span"));
